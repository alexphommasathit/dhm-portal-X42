      ...
      <div className="min-h-screen p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <p className="mb-4">
              This page is only accessible to users with administrative privileges. Your current
              role is <span className="font-semibold">{userRole}</span>.
            </p>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <div className="p-4 border rounded-lg bg-blue-50">
                ...
                <Link href="/admin/staff" className="text-blue-600 text-sm hover:underline">
                  Manage Users
                </Link>
              </div>
              ...
              <div className="p-4 border rounded-lg bg-purple-50">
                ...
                <button className="text-purple-600 text-sm hover:underline">Manage Roles</button>
              </div>
              ...
              <div className="p-4 border rounded-lg bg-green-50">
                ...
                <button className="text-green-600 text-sm hover:underline">Adjust Settings</button>
              </div>
            </div>
          </div>
