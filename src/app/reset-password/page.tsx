          ...
          <form onSubmit={handlePasswordUpdate} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${!isValidPassword && password ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${!passwordsMatch && confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <form onSubmit={handleResetRequest} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${!isValidEmail && email ? 'border-red-500' : 'border-gray-300'}`}
